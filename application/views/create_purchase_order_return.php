				...
				var addNewCustomer = $.ajax({
					...
					success	: function(data) {
						...
						if(status == "failure"){
							...
							var cell = $('<tr id="row_'+row_count+'"><td>'+pcode+'</td><td>'+name+'</td><td><input type="text" class="form-control" name="qty_'+row_count+'" value="1" style="width: 40%;" /></td><td><input type="text" class="form-control" name="price_'+row_count+'" value="1" style="width: 40%;" /></td><td><a onclick="deletediv('+row_count+')" style="cursor:pointer"><i class="icono-cross" style="color:#F00;"></i></a></td></tr><input type="hidden" class="form-control" name="pcode_'+row_count+'" value="'+pcode+'" />');
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	...
	<form action="<?=base_url()?>purchase_order/insertReturnPO" method="post" enctype="multipart/form-data">
	<div class="row">
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<div class="row" style="padding-top: 7px;">
						...
						<div class="col-md-8">
							<label>&nbsp;</label>
							<div class="button"style="background-color: #686868; color: #FFF; width: 200px; text-align: center; border-radius: 4px; padding: 9px 0px; cursor: pointer;" id="addToList"><?php echo $lang_add_to_list; ?></div>
						</div>
					</div>
	...
	<table class="table">
		<thead>
			<tr>
		    	...
		    	<th width="20%" style="background-color: #686868; color: #FFF;"><?php echo "Qty return"; ?></th>
				<th width="20%" style="background-color: #686868; color: #FFF;"><?php echo "Price"; ?></th>
