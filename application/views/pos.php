				...
				var resultPrice = $.ajax({
							...
							success	: function(data) {
								...
								if(add_row_count == 1){
									...
									if(qty >= 1){
										var msgs 		= '<div class="row" id="item_row_'+add_row_count+'" style="margin: 0px; border-bottom: 1px solid #dddddd; padding-top: 5px; padding-bottom: 5px;"><div class="col-md-4 col-sm-4 col-xs-4" style="background-color: #4d9fe4; color: #FFF;">'+name+' </div><div class="col-md-4 col-sm-4 col-xs-4" style="text-align: center; font-size: 15px; color: #000;"><div class="row"><div class="col-md-3 col-sm-3 col-xs-3" style="padding-top:7px"><span class="hidden-xs" onclick="minusDiv('+add_row_count+')" style="cursor:pointer;"><img src="<?=base_url()?>assets/img/minus_icon.png" /></span></div><div class="col-md-6 col-sm-6 col-xs-6" style="padding-left: 0px; padding-right: 0px;"><input type="text" id="display_qty_'+add_row_count+'" class="form-control" value="1" onchange="manualQty(this.value, '+add_row_count+')" style="text-align:center;" /></div><div class="col-md-3 col-sm-3 col-xs-3" style="padding-left:0px; padding-top:7px;"><span class="hidden-xs" onclick="plusDiv('+add_row_count+')" style="cursor:pointer;"><img src="<?=base_url()?>assets/img/plus_icon.png" /></span></div></div></div><div class="col-md-3 col-sm-3 col-xs-3">'+price+'</div><div class="col-md-1 col-sm-1 col-xs-1" style="font-weight: bold;"><span  onclick="deleteDiv('+add_row_count+')" style="cursor:pointer;">x</span></div></div><input type="hidden" name="pcode_'+add_row_count+'" id="pcode_'+add_row_count+'" value="'+pcode+'" /><input type="hidden" name="price_'+add_row_count+'" id="price_'+add_row_count+'" value="'+price+'" /><input type="hidden" name="qty_'+add_row_count+'" id="qty_'+add_row_count+'" value="1" />';
										logDiv.append( msgs + "" );
...
/*
								var msgs 		= '<div class="row" id="item_row_'+add_row_count+'" style="margin: 0px; border-bottom: 1px solid #dddddd; padding-top: 5px; padding-bottom: 5px;"><div class="col-md-6" style="background-color: #772953; color: #FFF;">'+name+' <br />['+pcode+']</div><div class="col-md-2">1</div><div class="col-md-3">'+price+'</div><div class="col-md-1" style="font-weight: bold;"><span onclick="deleteDiv('+add_row_count+')" style="cursor:pointer;">x</span></div><input type="hidden" name="pcode_'+add_row_count+'" id="pcode_'+add_row_count+'" value="'+pcode+'" /></div><input type="hidden" name="price_'+add_row_count+'" id="price_'+add_row_count+'" value="'+price+'" />';
								logDiv.append( msgs + "" );
*/
...
<div class="row" style="background-color: #373942; color: #FFF; font-weight: bold; padding-top: 10px; padding-bottom: 10px; margin: 0px; margin-top: 7px;">
	<div class="col-md-4 col-sm-4 col-xs-4"><?php echo $lang_products; ?></div>
	<div class="col-md-4 col-sm-4 col-xs-4 "style="text-align: center;"><?php echo $lang_qty; ?></div>
	<div class="col-md-3 col-sm-3 col-xs-3"><?php echo $lang_per_item; ?></div>
	<div class="col-md-1 col-sm-1 col-xs-1" style="font-weight: bold;">X</div>
</div>
<script type='text/javascript'>
...
<div id= "ecran" style="overflow: scroll; height: 330px; width: 100%;">
	<?php
        $suspend_id = 0;
            ...
            if (count($susData) == 1) {
                ...
                for ($si = 0; $si < count($susItemData); ++$si) {
					...
					<div class="row" id="item_row_<?php echo $sus_row_count; ?>" style="margin: 0px; border-bottom: 1px solid #dddddd; padding-top: 5px; padding-bottom: 5px;">
						<div class="col-md-4" style="background-color: #772953; color: #FFF;"><?php echo $pcode_name; ?><br />[<?php echo $sus_pcode; ?>]</div>
						<div class="col-md-4">
							<div class="row">
                                    ...
                                    ?>	
										...
										<?php
                                            ...
                                            for ($ap = 0; $ap < count($allProdData); ++$ap) {
												...
												<button onClick="scrollSmoothToBottom('ecran')" type="button" id="txtMessage_<?php echo $pp; ?>" value="<?php echo $pcode; ?>" style="margin-top: 10px; margin-left: 19px; border-radius: 5px; padding: 20px 10px 20px 10px; background-color: #772953; border: 0px; color: #FFF; font-family: Arial, Helvetica, sans-serif; font-size: 13px; width: 120px;">
												<?php
													...
													<?php
                                                      ...
                                                      $ckInvData = $this->Constant_model->getDataOneColumn('inventory', 'product_code', $pcode);
													$qty = $ckInvData[0]->qty;
       
															?>
													<span id="proname"><?php echo $name; ?> <br/>[<?php echo $qty; ?>]</span>
													<?php
                                        ...
                                        for ($ca = 0; $ca < count($catData); ++$ca) {
                                            ...
                                            for ($d = 0; $d < count($prodData); ++$d) {
                                                ...
                                                $image = $prodData[$d]->thumbnail; ?>
													<button type="button" id="txtMessage_<?php echo $pp; ?>" value="<?php echo $pcode; ?>" style="margin-top: 10px; margin-left: 19px; border-radius: 5px; padding: 20px 10px 20px 10px; background-color: #772953; border: 0px; color: #FFF; font-family: Arial, Helvetica, sans-serif; font-size: 13px; width: 120px;">
													<?php
                                                        if (($display_prod == '3') || ($display_prod == '2')) {
                                                            ?>	
														<?php
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body" style="overflow: visible; background-color: #FFF;">
					...
					<div class="modal-footer" style="margin-top: 10px;">
						<div name="pop_add_cust_submit" id="pop_add_cust_submit" value="Add Customer" onclick="stopclick(this)" class="btn btn-primary" style="background-color: #3fb618; color: #FFF; border: 0px; padding: 5px 25px; float: right;"><?php echo $lang_add_customer; ?></div>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body" style="overflow: visible; background-color: #FFF;">
					...
					<div class="row" style="margin-left: 10px; margin-right: 10px; padding-top: 7px; padding-bottom: 7px; background-color: #772953; letter-spacing: 0.5px; font-size: 16px;">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body" style="overflow: visible; background-color: #FFF;">
					...
					<div class="row" style="margin-top: 10px;">
						<div class="col-md-6"><b><?php echo "Bill Number"; ?></b></div>
						<div class="col-md-6">
							<input type="text" name="hold_ref" id="hold_ref" class="form-control" value="<?php echo (rand(1,9999));?>" />
						</div>
					</div>
					<div class="row" style="margin-top: 10px;">
						<div class="col-md-6"><b><?php echo "Description"; ?></b></div>
						<div class="col-md-6">
							<textarea  row="2" name="des_text" id="des_text" class="form-control" ></textarea>
						</div>
					</div>
					<div class="modal-footer" style="margin-top: 10px;">
...
<script type="text/javascript">		
	function checkChequePayment(ele){
		if(ele == "5"){			// Cheque;
			...
			document.getElementById("transfer_paid").style.display = "none"; 
			...
			document.getElementById("card_wrp").style.display = "none";
			document.getElementById("transfer_paid").style.display = "block"; 
        ...
        $("#card_numb").on("keyup", function(event) {
	        ...
	        if(card_numb.length == 0) {
				...
				document.getElementById("submit_btn").style.display = "none";
					...
					<div class="row" style="padding-top: 10px; padding-bottom: 10px;">
						<div class="col-md-6"><b><?php echo "Cash Amount"; ?> :</b></div>
						<div class="col-md-6">
							<input type="text" name="paid" id="paid" class="form-control" value="0" style="border: 1px solid #3a3a3a; color: #010101;" <?php if ($keyboard == '1') {
					...
					<div class="row" style="padding-top: 10px; padding-bottom: 10px;">
						<div id= "transfer_info" class="col-md-6"><b><?php echo "Transfer Amount:"; ?> :</b></div>
						<div class="col-md-6">
							<input type="text" name="transfer_paid" id="transfer_paid" class="form-control" value="0" style="border: 1px solid #3a3a3a; color: #010101;" <?php if ($keyboard == '1') {
                                ?>onchange="calculatePaidAmt(this.value)"<?php 
                            } ?> <?php if ($keyboard == '0') {
                                ?>onkeyup="calculatePaidAmt(this.value)"<?php 
                            } ?> autocomplete="off" />
				...
				<div class="modal-footer" style="margin-top: 0px;">
					<input type="submit" onclick="stopclick(this)"value="<?php echo $lang_submit; ?>" class="btn btn-primary" id="submit_btn" style="background-color: #3fb618; color: #FFF; border: 0px; padding: 5px 25px; float: right; display: none;" />
				</div>
			</div>
		</div>
	</div>
...
<script>
	...
	function deleteDiv(ele){
		...
		document.getElementById("price_"+ele).value = -1;
		document.getElementById("qty_"+ele).value 	= 0;
		document.getElementById("price_"+ele).value = 0;
		document.getElementById("price_"+ele).value = 0;
		document.getElementById("price_"+ele).type = 'hidden';
		var	row_count 		= document.getElementById("row_count").value;
	...
	function calculatePaidAmt(ele){	
		...
		var transfer_amt 		= document.getElementById("transfer_paid").value;
		var cash_paid 			= document.getElementById("paid").value;
		payable_amt 			= parseFloat(payable_amt);
		cash_paid 				= parseFloat(cash_paid);
		transfer_amt			= parseFloat(transfer_amt);
		var all_paid     = transfer_amt + cash_paid;
		
		
		if(paid_by == "6"){
			var change_amt 			= 0;
		} else {
			var change_amt 			= payable_amt - all_paid ;
		}
	...
	function stopclick(submit_btn){
		document.getElementById("submit_btn").style.display 	= "none";
		document.getElementById("pop_add_cust_submit").style.display 	= "none";
