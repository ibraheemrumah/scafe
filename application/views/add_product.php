					...
					<div class="row">
						...
						<!--<div class="col-md-4">
							<div class="form-group">
								...
								<input type="text" name="exp_date" class="form-control" maxlength="250" required autocomplete="off" placeholder="2021-02-01"/>
							</div>
						</div>-->
						<div class="col-md-4">
							<div class="form-group">
								<label><?php echo "Item Qty"; ?>  <span style="color: #F00">*</span></label>
