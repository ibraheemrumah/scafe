...
<style type="text/css" media="all">
	...
	@media print {
		...
		#wrapper { width: 100%; margin: 0; font-size:10px font-weight:bold; }
...
<body>
<div id="wrapper">
    <h2 style="padding-top: 0px; padding-bottom: 20px; font-size: 18px;"><strong><?php echo $outlet_name; ?></strong></h2>
	...
	<span class="left"><?php echo "Return ID"; ?> : <?php echo $return_id; ?></span>
	...
	<table class="table" cellspacing="0"  border="0"> 
		...
		<?php
            ...
            for ($i = 0; $i < count($itemData); ++$i) {
				...
				<tr>
				<tr>
				<h3>RETURN ORDER RECEIPT </h3>
				<h4 ><?php echo "KULA: BA'A KARBAN KAYA DA WANNAN SAI KUDI" ?></h4>
				</tr>
