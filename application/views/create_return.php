				...
				var addNewCustomer = $.ajax({
					...
					success	: function(data) {
						...
						if(status == "failure"){
							...
							var cell = $('<tr id="row_'+row_count+'"><td>'+pcode+'</td><td>'+name+'</td><td><input type="text" class="form-control" name="qty_'+row_count+'" value="1" style="width: 50%;" /></td><td> <input id="box_'+row_count+'" type="checkbox" name="cond_'+row_count+'" checked/><label for="box_'+row_count+'"><?php echo $lang_good; ?></label> </td><td><a onclick="deletediv('+row_count+')" style="cursor:pointer"><i class="icono-cross" style="color:#F00;"></i></a></td></tr><input type="hidden" class="form-control" name="pcode_'+row_count+'" value="'+pcode+'" />');
					...
					<div class="row">
						<!---<div class="col-md-3">
							<div class="form-group">
								...
								<select name="customer" class="form-control" style="width: 100%;"  id="customerSearch">
