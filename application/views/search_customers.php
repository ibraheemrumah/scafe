				...
				<div class="panel-body">
					...
					<form action="<?=base_url()?>customers/searchcustomer" method="get">
						<div class="row" style="margin-top: 10px;">
							...
							<div class="col-md-3">
								<div class="form-group">
									<label><?php echo "Shop Address"; ?> <span style="color: #F00">*</span></label>
								...
								<table class="table">
									<thead>
										<tr>
										    ...
										    <th style="border-left: 1px solid #ddd; border-bottom: 1px solid #ddd; border-top: 1px solid #ddd;" width="19%">
			...
			<tr>
				...
				<td>
					...
					<a href="<?=base_url()?>customers/debit_history?cust_id=<?php echo $cust_id; ?>" style="text-decoration: none; margin-left: 10px;">
									<button class="btn btn-primary" style="padding: 4px 12px;">&nbsp;&nbsp;<?php echo "Debit"; ?>&nbsp;&nbsp;</button>
								</a>
				</td>
			</tr>
<?php
