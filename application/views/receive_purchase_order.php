	...
	<table class="table">
		<thead>
			<tr>
				...
				<th width="15%" style="background-color: #686868; color: #FFF;"><?php echo "Sales Price"; ?> (<?php echo $currency; ?>)</th>
			</tr>
		</thead>
		<?php
            $jj = 1;
            ...
            for ($pi = 0; $pi < count($poItemData); ++$pi) {
				...
				$po_retail_price = $poNameData[0]->retail_price;
				$purchase_price = $poNameData[0]->purchase_price;
				?>
				<tr>
					...
					<?php
                        if ($po_rec_qty != 0) {
                            ...
                            ?>
						<input type="text" id="qty_<?php echo $jj; ?>" name="receiveQty_<?php echo $po_item_id; ?>" class="form-control" value="<?php echo $po_item_qty; ?>"style="width: 80%;" onkeyup="getValue()" />
					<?php
					...
					<?php
                        if ($po_rec_qty != 0) {
                            ...
                            ?>
						<input type="text" id="cost_<?php echo $jj; ?>" name="receiveCost_<?php echo $po_item_id; ?>" autofocus  value="<?php echo $purchase_price; ?>"class="form-control" style="width: 80%;" onfocus="getValue()" />
					<?php
					...
					<?php
                        if ($po_rec_qty != 0) {
                            ...
                            ?>
						<input type="text" id="price_<?php echo $jj; ?>" name="receivePrice_<?php echo $po_item_id; ?>" value="<?php echo $po_retail_price; ?>"class="form-control" style="width: 80%;" onkeyup="getValue()" />
					<?php
        ...
        ?>
        		...
        		<tr>
				<td style="vertical-align: middle; text-align: right; border-top: 1px solid #000;">
		        		<b><?php echo "Return Change"; ?> (<?php echo $currency; ?>) :</b>
	        		</td>
				<td style="border-top: 1px solid #000; vertical-align: middle;">
		        		<?php
                            if ($po_status != '3') {
                                ?>
		        		<input type="text" name="return_change" id="r_change" class="form-control" onkeyup="calculateDiscount(this.value)" />
		        		<?php

                            } else {
                                echo number_format($rchange, 2, '.', '');
                            }
                        ?>
	        		</td>
	        		<td colspan="2" align="right" valign="middle" style="vertical-align : middle;"><b><?php echo $lang_tax; ?> (<?php echo $tax; ?>%) (<?php echo $currency; ?>) :</b></td>
