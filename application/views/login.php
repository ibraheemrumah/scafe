...
<body style="background-color: #ffffff;">
	...
	<div class="row">
		<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div class="login-panel panel panel-default" style="border: 1px solid #333333;'">
				<div class="panel-heading" style="height: 175px; padding-top: 25px;">
					<strong><?php echo $setting_site_name; ?></strong>
					<br />
					...
					<form action="<?=base_url()?>auth/login" method="post">
						<fieldset>
							<div class="form-group">
								<input type="email" name="email" class="form-control" autofocus autocomplete="on" required placeholder="Email Address" />
							</div>
							<div class="form-group">
	...
	<div class="login_footer">
		<div class="copy">Poweredby - Mu'ammil Web Dev. Services. Tel:08066620283</div>
	</div>
