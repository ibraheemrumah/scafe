	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<ul class="nav menu">
			...
			<li <?php if ($tk_c == 'debit') {
				...
				<a href="<?=base_url()?>debit/view"><?php echo "Debit Transaction"; ?></a>
			</li>
			...
			<li <?php if ($tk_c == 'sales') {
				...
				<ul class="children <?php if ($tk_c != 'sales') {
					...
					<li>
						<a <?php if (($tk_m == 'list_sales')) {
                            ?> style="background-color: #e9ecf2;" <?php 
                        } ?> href="<?=base_url()?>reports/sold_by_products">
							<?php echo "Sold Products"; ?>
						</a>
					</li>
					<li>
			...
			<li <?php if ($tk_c == 'reports') {
				...
				<ul class="children <?php if ($tk_c != 'reports') {
					...
					<li>
						<a <?php if (($tk_m == 'sales_report')) {
                        ?> style="background-color: #e9ecf2;" <?php 
                    } ?> href="<?=base_url()?>customers/report">
							<?php echo "Customer Report"; ?>
						</a>
					</li>
					<li>
						<a <?php if (($tk_m == 'sales_report')) {
                        ?> style="background-color: #e9ecf2;" <?php 
                    } ?> href="<?=base_url()?>purchase_order/report">
							<?php echo "Purchase Order Report"; ?>
						</a>
					</li>
				</ul>
			</li>
			...
			<li <?php if ($tk_c == 'returnorder') {
				...
				<ul class="children <?php if ($tk_c != 'returnorder') {
					...
					<li>
						<a <?php if (($tk_m == 'return_report')) {
                    ?> style="background-color: #e9ecf2;" <?php 
                } ?> href="<?=base_url()?>reports/bad_products">
							<?php echo "Bad Return"; ?>
						</a>
					</li>
				</ul>
			...
			<li <?php if ($tk_c == 'inventory') {
				...
				<a data-toggle="collapse" href="#sub-item-inventory">
					<?php echo "Stock"; ?>
				</a>
				<ul class="children <?php if ($tk_c != 'inventory') {
                    ?> collapse <?php 
                } ?>" id="sub-item-inventory">
					<li>
						<a <?php if ($tk_m == 'search_inventory') {
                    ?> style="background-color: #e9ecf2;" <?php 
                } ?> href="<?=base_url()?>inventory/view"><?php echo $lang_inventory; ?>
						</a>
					</li>
					<li>
						<a <?php if ($tk_m == 'search_inventory') {
                    ?> style="background-color: #e9ecf2;" <?php 
                } ?> href="<?=base_url()?>inventory/searchInventory">
							<?php echo "Search Product"; ?>
						</a>
					</li>
