						...
						<div class="col-md-12">
							...
							<div class="">
								<table id="example" class="table table-bordered" cellspacing="0" width="100%">
									<thead>
										<tr>
								    	<th class="hidden-xs" width="10%"><?php echo "Number"; ?></th>
									    <th width="10%"><?php echo "Category"; ?></th>
									    <th  class="hidden-xs" width="10%"><?php echo $lang_outlets; ?></th>
                                        ...
                                        if (count($results) > 0) {
                                            foreach ($results as $data) {
												...
												<tr>
													...
													<td class="hidden-xs"><?php echo $number; ?></td>
													<td><?php echo $exp_cat_name; ?></td>
													<td  class="hidden-xs"><?php echo $outlet_name; ?></td>
													<td><?php echo $date; ?></td>
