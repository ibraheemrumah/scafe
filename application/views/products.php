					...
					<div class="row" style="margin-top: 0px;">
						...
						<div class="">
							<table id="example" class="table table-bordered" cellspacing="0" width="100%">
							    <thead>
							    	<tr>
								    	<th class="hidden-xs" width="10%"><?php echo $lang_code; ?></th>
								    	<th width="20%"><?php echo $lang_name; ?></th>
								    	
								    	<th width="15%"><?php echo $lang_category; ?></th>
								    	<th class="hidden-xs" width="10%"><?php echo $lang_cost; ?></th>
								    	<th width="10%"><?php echo $lang_price; ?></th>
									    <th class="hidden-xs" width="10%"><?php echo $lang_status; ?></th>
								...
								<?php
                                    if (count($results) > 0) {
                                        foreach ($results as $data) {
                                            ...
                                            $large_file_path = ''; ?>
											<tr>
												<td class="hidden-xs"><?php echo $code; ?></td>
												<td><?php echo $name; ?></td>
												
												<td><?php echo $category_name; ?></td>
												<td class="hidden-xs"><?php echo number_format($cost, 2); ?></td>
