...
?>
<?php
    $poDtaData = $this->Constant_model->getDataOneColumn('return_purchases', 'id', $id);
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header"><?php echo "Return Purchase Order Item"; ?></h1>
		</div>
	</div><!--/.row-->
	...
	<table class="table">
		<thead>
			<tr>
		    	...
		    	<th width="17.5%" style="background-color: #686868; color: #FFF;"><?php echo $lang_product_name; ?></th>
		    	<th width="17.5%" style="background-color: #686868; color: #FFF;"><?php echo "Return Qty"; ?></th>
		    	
		    	<th width="15%" style="background-color: #686868; color: #FFF;"><?php echo $lang_each_cost; ?></th>
			</tr>
		</thead>
		<?php
            $poItemData = $this->Constant_model->getDataOneColumnSortColumn('return_purchase_order_items', 'po_id', $id, 'id', 'ASC');
