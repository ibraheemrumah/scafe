...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header"><?php echo "EXPIRED DRUGS"; ?></h1>
		</div>
	</div><!--/.row-->
							...
							<table class="table">
							    <thead>
							    	<tr>
								    	...
								    	<th width="20%"><?php echo $lang_total_quantity; ?></th>
								    	<th width="20%">Total Cost</th> 
									    <th width="25%"><?php echo "Expire Date"; ?></th>
									</tr>
							    </thead>
								<tbody>
<?php
    $sort = '';
	$date = date("Y-m-d");
	$exp_date = date('Y-m-d' , strtotime($date. ' + 6 month'));
    ...
    $prodResult = $this->db->query("SELECT * FROM products WHERE exp_date <= '$exp_date' $sort ");
