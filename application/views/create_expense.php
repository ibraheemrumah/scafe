...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header"><?php echo "Create Today's Expenses"; ?></h1>
		</div>
	</div><!--/.row-->
	
	<form action="<?=base_url()?>expenseorder/insertReturnOrder" method="post" onsubmit="return confirm('<?php echo "Are you confirm to create Expense Order"; ?>')">
	<div class="row">
		<div class="col-md-12">
	    ...
	    if(ele.length > 0){
			...
			document.getElementById("refund_grand").value 		= 0;  
					...
					<div class="row">
						<div class="col-md-7">
							<div class="form-group">
								<label style="font-size: 13px;"><?php echo "Expense Details"; ?></label>
					...
					<div class="row">
						<div class="col-md-3">
							<div class="form-group">
								<label style="font-size: 13px;"><?php echo "Total Amount"; ?> (<?php echo $currency; ?>)</label>
							</div>
						</div>
						<div class="col-md-4">
