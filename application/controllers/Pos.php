...
class Pos extends CI_Controller
{
    ...
    public function view_hold()
    {
        ...
        $this->load->view('print_hold', $data);
    }
...
// View Deposit Slip;
    public function deposit()
    {
        ...
        $this->load->view('print_deposit', $data);
    }
    // View Invoice A4;
    ...
    public function insertSale()
    {
        if (isset($_POST['hold_bill_submit'])) {
            ...
            $des_text = $this->input->post('des_text');
			...
			redirect(base_url().'pos/view_hold?id='.$sus_id, 'refresh');
		...
		<?php
			...
			$transfer_paid_amt = $this->input->post('transfer_paid');
			$eat_type = $this->input->post('eat_type');
			...
			$orderNameData = $this->Constant_model->getDataOneColumn('order_type', 'id', $eat_type);
            if (count($orderNameData) == 1) {
                $order_name = $orderNameData[0]->type;
            ...
            if (empty($dis_amt)) {
				...
				$paid_amt_all = $paid_amt + $transfer_paid_amt;
            // Insert Into Order;
            $ins_order_data = array(
					...
					//'order_id_type' 		=> 	$eat_type,
                   // 'order_type' 			=> 	$order_name,
                    'cheque_number' 		=> 	$cheque,
                    'paid_amt' 				=> 	$paid_amt_all,
	        ...
	        $transfer_amount 		= $transfer_paid_amt;
